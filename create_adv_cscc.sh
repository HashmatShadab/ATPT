...
#sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets GPU WORKERS vit_l_14_datacomp_1b EPS STEPS TTA_STEPS 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/atpt_results PURIFY TYPE ANCHORS ALPHA SIGMA THRESH"
# Alpha 1.2 Sigma 0.18
sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets 0 4 ViT-L/14 4.0 100 1 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/Projects/ATPT/Purify_Results_Cscc true noisy_anchor 1 1.2 0.18 0.0"
...
#sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets 0 4 delta_clip_l14_224 4.0 100 1 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/Projects/ATPT/Purify_Results_Cscc true noisy_anchor 1 1.2 0.18 0.0"
#sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets 0 4 fare4 4.0 100 1 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/Projects/ATPT/Purify_Results_Cscc true noisy_anchor 1 1.2 0.18 0.0"
...
#sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets 0 4 fare4 4.0 100 1 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/Projects/ATPT/Purify_Results_Cscc true noisy_anchor 1 1.2 0.06 0.0"

# Alpha 1.2 Sigma 0.12
sbatch run.sh "bash gen_adv.sh /l/users/hashmat.malik/downstream_datasets 0 4 ViT-L/14 4.0 100 1 0.1 20 0.01 /l/users/hashmat.malik/atpt_results /l/users/hashmat.malik/Projects/ATPT/Purify_Results_Cscc true noisy_anchor 1 1.2 0.12 0.0"
