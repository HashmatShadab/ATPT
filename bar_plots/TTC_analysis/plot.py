...
def get_ttc_results(model_name):
        ...
        "ttc": {
            "clean": {
                "base_path": (
                    ...
                    "{model}/{dataset}/"
                    "Clean/Counter_Attack/Eps_4_0_Steps_5_Alpha_1_0/tau_0_2_beta_2_0_weighted_pertrubation_True/No_TPT/"
                    "Inference_Ensemble_all_weighted_rtpt_topk_20_softmaxtemp_0_01"
                ),
            },
            "adversarial_eps4_steps100": {
                "base_path": (
                    ...
                    "{model}/{dataset}/"
                    "Adversarial_Eps_4_0_Steps_100/"
                    "Counter_Attack/Eps_4_0_Steps_5_Alpha_1_0/tau_0_2_beta_2_0_weighted_pertrubation_True/No_TPT/"
                    "Inference_Ensemble_all_weighted_rtpt_topk_20_softmaxtemp_0_01"
                ),
            },
            "adversarial_eps4_steps100_image_only": {
    ...
    return_dic = {"zero_shot_clean": ZS_CLEAN_PREDS_DATASET, "zero_shot_adv": ZS_ADV_PREDS_DATASET, "zero_shot_adv_image_only": ZS_ADV_IMAGE_ONLY_PREDS_DATASET,
                 "ttc_single_clean": TTC_CLEAN_PREDS_SINGLE_DATASET, "ttc_single_adv": TTC_ADV_PREDS_SINGLE_DATASET, "ttc_single_adv_image_only": TTC_ADV_IMAGE_ONLY_PREDS_SINGLE_DATASET,
                 "true_labels": TRUE_LABELS_DATASET}
    return return_dic
