...
COMMON_PARAMS+=" --softmax_temp $SOFTMAX_TEMP_FOR_SIMILARITY_WEIGHTING --print-freq 20 --checkpoint_freq 1000"

# Model parameters
MODEL="-a $MODEL_NAME -b 64 --adv_bs 64"
...
if [ "$DATASET_ID" = "all"   ]; then
  ...
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets DTD $MODEL $COMMON_PARAMS
  echo "  ✓ DTD dataset Adv Examples  complete"

  echo "  [2/8] Adv Examples  Flower102 dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets Flower102 $MODEL $COMMON_PARAMS
  echo "  ✓ Flower102 dataset Adv Examples  complete"

  echo "  [3/8] Adv Examples  Cars dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets Cars $MODEL $COMMON_PARAMS
  echo "  ✓ Cars dataset Adv Examples  complete"

  echo "  [4/8] Adv Examples  Aircraft dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets Aircraft $MODEL $COMMON_PARAMS
  echo "  ✓ Aircraft dataset Adv Examples  complete"

  echo "  [5/8] Adv Examples  Pets dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets Pets $MODEL $COMMON_PARAMS
  echo "  ✓ Pets dataset Adv Examples  complete"

  echo "  [6/8] Adv Examples  Caltech101 dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets Caltech101 $MODEL $COMMON_PARAMS
  echo "  ✓ Caltech101 dataset Adv Examples  complete"

  echo "  [7/8] Adv Examples  UCF101 dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets UCF101 $MODEL $COMMON_PARAMS
  echo "  ✓ UCF101 dataset Adv Examples  complete"

  echo "  [8/8] Adv Examples  eurosat dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets eurosat $MODEL $COMMON_PARAMS
  ...
  echo "  [1/1] Adv Examples  ImageNet dataset..."
  CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets I $MODEL $COMMON_PARAMS
  echo "  ✓ eurosat dataset Adv Examples  complete"
...
#CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets A $MODEL $COMMON_PARAMS
#echo "  ✓ ImageNet-A dataset Adv Examples  complete"
#
#echo "  [2/5] Adv Examples  ImageNet-R dataset..."
#CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets R $MODEL $COMMON_PARAMS
#echo "  ✓ ImageNet-R dataset Adv Examples  complete"
#
#echo "  [3/5] Adv Examples  ImageNet-S dataset..."
#CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets K $MODEL $COMMON_PARAMS
#echo "  ✓ ImageNet-S dataset Adv Examples  complete"
#
#echo "  [4/5] Adv Examples  ImageNet-V dataset..."
#CUDA_VISIBLE_DEVICES=$GPU python get_mean_std.py $DATA_ROOT --test_sets V $MODEL $COMMON_PARAMS
