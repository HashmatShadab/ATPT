...
class PGD_PRM(Attack):
    ...
    def forward(self, images, labels):
        ...
        for _ in range(self.steps):
            ...
            adv_outputs_features_list = self.get_logits(self.input_diversity(adv_images_for_grad), get_prm_layer_features=True, normalize=False)
